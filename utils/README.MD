This is where all the service URLs and the service will reside for the util user. This specific user is where common services are deployed for either dev or ops user to use.
